...
RSpec.describe Sidekiq::AsyncHttp::TimeHelper do
  ...
  describe "#wall_clock_time" do
    ...
    it "can be used as a module method" do
      ...
      monotonic = Sidekiq::AsyncHttp::TimeHelper.monotonic_time
      wall_clock = Sidekiq::AsyncHttp::TimeHelper.wall_clock_time(monotonic)
  ...
  describe "when included in a class" do
    let(:test_class) do
      Class.new do
        include Sidekiq::AsyncHttp::TimeHelper
