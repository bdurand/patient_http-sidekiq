...
module Sidekiq
  module AsyncHttp
    # The RequestTemplate is used to build HTTP requests with shared configuration for asynchronous execution.
    #
    ...
    #   request.execute(callback: MyCallback, callback_args: {user_id: 123})
    #
    ...
    # and parameter encoding. Call +execute+ on the returned Request to enqueue it.
    class RequestTemplate
      ...
      #
      # Call +execute+ on the returned Request to enqueue it for processing.
